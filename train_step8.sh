...
########## train
  ...
  time  python train.py  --config 'configs/step8/config1.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step8/config2.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step8/config3.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step8/config4.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step8/config5.tagging.5k.yaml'

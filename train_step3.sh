...
########## train
  ...
  time  python train.py  --config 'configs/step3/config1.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step3/config2.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step3/config3.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step3/config4.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step3/config5.tagging.5k.yaml'

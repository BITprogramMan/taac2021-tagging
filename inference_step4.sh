...
########## train
  ...
  time  python inference.py --model_pb './checkpoints/step4/tagging5k_temp1/export/' \
                            --output 'step4/results1/result_for_vis.txt' \
                            --output_json 'step4/results1/tagging_1.json' \
                            --tag_id_file '../dataset/label_id.txt' \
                            --test_dir '../dataset/videos/test_5k_2nd' \
                            --feat_dir  '../dataset/tagging/tagging_dataset_test_5k_2nd'
                            
                            
  time  python inference.py --model_pb './checkpoints/step4/tagging5k_temp2/export/' \
                            --output 'step4/results2/result_for_vis.txt' \
                            --output_json 'step4/results2/tagging_2.json' \
                            --tag_id_file '../dataset/label_id.txt' \
                            --test_dir '../dataset/videos/test_5k_2nd' \
                            --feat_dir  '../dataset/tagging/tagging_dataset_test_5k_2nd'
                            
                            
  time  python inference.py --model_pb './checkpoints/step4/tagging5k_temp3/export/' \
                            --output 'step4/results3/result_for_vis.txt' \
                            --output_json 'step4/results3/tagging_3.json' \
                            --tag_id_file '../dataset/label_id.txt' \
                            --test_dir '../dataset/videos/test_5k_2nd' \
                            --feat_dir  '../dataset/tagging/tagging_dataset_test_5k_2nd'
                            
                            
  time  python inference.py --model_pb './checkpoints/step4/tagging5k_temp4/export/' \
                            --output 'step4/results4/result_for_vis.txt' \
                            --output_json 'step4/results4/tagging_4.json' \
                            --tag_id_file '../dataset/label_id.txt' \
                            --test_dir '../dataset/videos/test_5k_2nd' \
                            --feat_dir  '../dataset/tagging/tagging_dataset_test_5k_2nd'
                            
                            
  time  python inference.py --model_pb './checkpoints/step4/tagging5k_temp5/export/' \
                            --output 'step4/results5/result_for_vis.txt' \
                            --output_json 'step4/results5/tagging_5.json' \
                            --tag_id_file '../dataset/label_id.txt' \
                            --test_dir '../dataset/videos/test_5k_2nd' \
                            --feat_dir  '../dataset/tagging/tagging_dataset_test_5k_2nd'


  time python merge_result_5group.py --result1 'step4/results1/tagging_1.json' \
                                     --result2 'step4/results2/tagging_2.json' \
                                     --result3 'step4/results3/tagging_3.json' \
                                     --result4 'step4/results4/tagging_4.json' \
                                     --result5 'step4/results5/tagging_5.json' \
                                     --output_json 'step4/bagging_step4.json'
else

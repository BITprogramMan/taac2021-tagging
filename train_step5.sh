...
########## train
  ...
  time  python train.py  --config 'configs/step5/config1.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step5/config2.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step5/config3.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step5/config4.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step5/config5.tagging.5k.yaml'

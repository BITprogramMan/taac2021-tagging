...
########## train
  ...
  time  python train.py  --config 'configs/step6/config1.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step6/config2.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step6/config3.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step6/config4.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step6/config5.tagging.5k.yaml'

...
########## train
  ...
  time  python train.py  --config 'configs/step7/config1.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step7/config2.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step7/config3.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step7/config4.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step7/config5.tagging.5k.yaml'

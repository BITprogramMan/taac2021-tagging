...
########## train
  ...
  time  python train.py  --config 'configs/step4/config1.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step4/config2.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step4/config3.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step4/config4.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step4/config5.tagging.5k.yaml'

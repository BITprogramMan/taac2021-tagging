...
########## train
  ...
  time  python train.py  --config 'configs/step9/config1.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step9/config2.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step9/config3.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step9/config4.tagging.5k.yaml' 
  time  python train.py  --config 'configs/step9/config5.tagging.5k.yaml'
